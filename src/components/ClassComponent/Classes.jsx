            ...
            <div className="addUser">
                ...
                <div className="addUserForm">
                    <div className="inputGrop">
                        <input type="text" placeholder="Enter your class Name" name="name" value={name}
                            onChange={(e) => setName(e.target.value)} />
                    </div>
                    <div className="inputGrop">
                        <input type="text" placeholder="Enter Year" name="year" value={year}
                            onChange={(e) => setYear(e.target.value)} />
                    </div>
                    <div className="inputGrop">
                        <input type="text" placeholder="Teacher Name" name="teacher" value={teacher}
                            onChange={(e) => setTeacher(e.target.value)} />
                    </div>
                    <div className="inputGrop">
                        <input type="text" placeholder="Student Fees" name="student" value={student}
                            onChange={(e) => setStudent(e.target.value)} />
                    </div>
                    <div className="inputGrop">
                        <input type="text" placeholder="Students List" name="student_list" value={student_list}
